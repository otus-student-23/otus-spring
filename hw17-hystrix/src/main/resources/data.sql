...
insert into book_comment(id, book_id, create_date, comment) values (
    'd603be04-3157-4746-900f-11cab7aba5c1',
    'f8c9bdb7-2709-4721-9426-57e1b8f4d629',
    '2023-08-01T01:01:01.000',
    'Комментарий 1');
insert into book_comment(id, book_id, create_date, comment) values (
    '665495d9-c0e2-436d-a219-5bfc130deff6',
    'f8c9bdb7-2709-4721-9426-57e1b8f4d629',
    '2023-08-02T02:02:02.000',
    'Комментарий 2');
insert into book_comment(id, book_id, create_date, comment) values (
    '96be3d60-3673-4a41-a48a-2933356da0f4',
    '342cf472-d40e-45d1-a290-a1879f4c1da1',
    '2023-08-03T03:03:03.000',
    'Комментарий 3');
...
values
    -- admin / admin
    -- user / user
    ('66b95650-e7a2-440f-8d86-39aa4befa52e', 'admin', '$2y$10$vTpVAbdUIB.76COt5qzrrO2GdORuBXaZptSgdJoK2/R7xpBbJlXW6', 'ROLE_ADMIN'),
    ('8f30e1d3-d131-4f4b-8857-5ac312831f38', 'user', '$2y$10$VtFR7P6TJGSjAQzfV6uw0.lqqivgXKt7vp08WV9FFNk/FMx4L/YRO', 'ROLE_USER');
